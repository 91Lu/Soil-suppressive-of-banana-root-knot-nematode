...
p2 <- ggplot(lmm, aes(x = asv, y = meloi)) + geom_point(aes(colour = Modules,shape = Years), size = 2) +
  ...
  theme_test() +
  theme(text = element_text(colour='black',size=8), axis.text=element_text(colour='black',size=8),
